...
<head>
        ...
        <title><?php echo $website_name?> | Forget</title>
        ...
        <meta property="og:title" content="<?php echo $website_name?> | Forget" />
        ...
        <meta property="twitter:title" content="<?php echo $website_name?> | Forget" />
