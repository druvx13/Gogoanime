...
<head>
        ...
        <title><?php echo $website_name?> | Register</title>
        ...
        <meta property="og:title" content="<?php echo $website_name?> | Register" />
        ...
        <meta property="twitter:title" content="<?php echo $website_name?> | Register" />
